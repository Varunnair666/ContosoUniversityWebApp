...
namespace ContosoUniversityWebApp.Controllers
{
    public class EnrollmentController : Controller
    {
        ...
        {
            var enrollemnts = db.Enrollemnts.Include(e => e.Course).Include(e => e.Student);
            return View(enrollemnts.ToList());
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            Enrollment enrollment = db.Enrollemnts.Find(id);
            if (enrollment == null)
            {
                return HttpNotFound();
            }
        ...
        {
            Enrollment enrollment = db.Enrollemnts.Find(id);
            db.Enrollemnts.Remove(enrollment);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
